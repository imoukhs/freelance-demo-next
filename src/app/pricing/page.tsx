          ...
          >
            ...
            <div className="relative max-w-xl mx-auto">
              ...
              <p className="text-white/60 text-sm md:text-base mb-10 leading-relaxed">
                Send me a message on WhatsApp and we&apos;ll figure out the right scope
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2.5 bg-white font-bold text-sm px-9 py-4 rounded-full transition-all hover:opacity-90 hover:-translate-y-0.5 shadow-xl"
                style={{
